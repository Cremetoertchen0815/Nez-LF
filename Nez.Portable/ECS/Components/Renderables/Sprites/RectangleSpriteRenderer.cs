...
namespace Nez
{
	...
	/// </summary>
	public class RectangleSpriteRenderer : SpriteRenderer
	{
		...
		public RectangleSpriteRenderer(float width, float height, Texture2D texture) : base(texture)
		{
			_width = width;
			_height = height;
		}
		...
		public RectangleSpriteRenderer SetWidth(float width)
		{
			_width = width;
			return this;
		}
		...
		public RectangleSpriteRenderer SetHeight(float height)
		{
			_height = height;
			return this;
		}
		...
		public RectangleSpriteRenderer SetSkew(float skewTopX, float skewBottomX, float skewLeftY, float skewRightY)
		{
			SkewTopX = skewTopX;
